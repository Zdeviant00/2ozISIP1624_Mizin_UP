...
**Реализованный функционал:**
- ✅ Примитивное меню для навигации
...
![Рисунок 4.1 — Главное меню](05_Console_App/Screenshots/01_MainMenu.png)

*На рисунке 4.1 представлено главное меню приложения с пунктами для демонстрации возможностей работы с буфером экрана.*

---

#### 4.2.2. Вывод результатов на второй буфер экрана (требование 1.3.1)
...
![Рисунок 4.2 — Второй буфер экрана](05_Console_App/Screenshots/02_SearchSuccess.png)

*На рисунке 4.2 показан результат поиска книги «Звёздный путь». Информация выведена на второй буфер экрана, что демонстрирует переключение между буферами (требование 1.3.1).*
...
![Рисунок 4.3 — Информация о буферах](05_Console_App/Screenshots/04_BufferInfo.png)
...
![Рисунок 4.4 — Изменение размеров](05_Console_App/Screenshots/05_ResizeBuffer.png)
...
![Рисунок 4.5 — Каталог книг](05_Console_App/Screenshots/03_Catalog.png)
...
1. **Работа с дескрипторами объектов ядра ОС** — `GetStdHandle`, `CreateConsoleScreenBuffer`, `CloseHandle`
2. **Прямой вызов функций Windows API** — функции из `windows.h` для работы с консолью
3. **Работа со структурами данных ОС** — `CONSOLE_SCREEN_BUFFER_INFO`, `COORD`
4. **Управление буферами консоли** — создание, переключение, изменение параметров
5. **Функции ввода-вывода высокого уровня** — `WriteConsoleA()`
6. **Управление ресурсами ОС** — корректное создание и освобождение системных ресурсов
...
- ✅ **Создан второй буфер экрана** (`CreateConsoleScreenBuffer`) — требование 1.1.1
- ✅ **Второй буфер сделан активным** (`SetConsoleActiveScreenBuffer`) — требование 1.1.2
- ✅ **Выведена информация о буфере экрана** (`GetConsoleScreenBufferInfo`) — требование 1.2.1
- ✅ **Установлены новые размеры буфера** (`SetConsoleScreenBufferSize`) — требование 1.2.2
- ✅ **Выведены результаты на второй буфер функцией высокого уровня** `WriteConsoleA()` — требование 1.3.1

Приложение полностью соответствует требованиям методической разработки (Раздел 4) и демонстрирует навыки системного программирования на языке C++ с использованием Windows API.

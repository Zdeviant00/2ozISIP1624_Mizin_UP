...
Пароли хранятся в открытом виде (plain text) для упрощения демонстрации. В промышленной версии необходимо использовать хэширование (bcrypt/Argon2).
...
Разработано консольное приложение «Онлайн библиотека» на языке **C++**, демонстрирующее навыки системного программирования в среде Windows — работу с буфером экрана через Windows API.

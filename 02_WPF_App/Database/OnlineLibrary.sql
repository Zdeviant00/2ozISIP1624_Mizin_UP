...
-- Пользователи
-- Пароль для всех: 123456 (PLAIN TEXT для демонстрации)
INSERT INTO Users (Login, PasswordHash, Email, Name, RoleId, IsFrozen, FreezeReason) VALUES
('admin', '123456', 'admin@library.ru', 'Администратор Системы', 2, 0, NULL),
('reader1', '123456', 'reader1@mail.ru', 'Иван Петров', 1, 0, NULL),
('reader2', '123456', 'reader2@mail.ru', 'Мария Сидорова', 1, 0, NULL),
('reader3', '123456', 'reader3@mail.ru', 'Алексей Козлов', 1, 1, 'Нарушение правил сообщества'),
('reader4', '123456', 'reader4@mail.ru', 'Елена Волкова', 1, 0, NULL);
GO
